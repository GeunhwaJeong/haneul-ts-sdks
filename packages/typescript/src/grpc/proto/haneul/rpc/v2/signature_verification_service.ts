...
// @generated from protobuf file "haneul/rpc/v2/signature_verification_service.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
/**
 * @generated from protobuf message haneul.rpc.v2.VerifySignatureRequest
 */
export interface VerifySignatureRequest {
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.Bcs message = 1;
	 */
	message?: Bcs;
	/**
	 * The signature to verify.
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.UserSignature signature = 2;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated haneul.rpc.v2.ActiveJwk jwks = 4;
	 */
	jwks: ActiveJwk[];
}
/**
 * @generated from protobuf message haneul.rpc.v2.VerifySignatureResponse
 */
...
class VerifySignatureRequest$Type extends MessageType<VerifySignatureRequest> {
	constructor() {
		super('haneul.rpc.v2.VerifySignatureRequest', [
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.VerifySignatureRequest
 */
...
class VerifySignatureResponse$Type extends MessageType<VerifySignatureResponse> {
	constructor() {
		super('haneul.rpc.v2.VerifySignatureResponse', [
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.VerifySignatureResponse
 */
export const VerifySignatureResponse = new VerifySignatureResponse$Type();
/**
 * @generated ServiceType for protobuf service haneul.rpc.v2.SignatureVerificationService
 */
