...
export interface IMovePackageServiceClient {
	/**
	 * @generated from protobuf rpc: GetPackage(haneul.rpc.v2.GetPackageRequest) returns (haneul.rpc.v2.GetPackageResponse);
	 */
	getPackage(
	...
	/**
	 * @generated from protobuf rpc: GetDatatype(haneul.rpc.v2.GetDatatypeRequest) returns (haneul.rpc.v2.GetDatatypeResponse);
	 */
	getDatatype(
	...
	/**
	 * @generated from protobuf rpc: GetFunction(haneul.rpc.v2.GetFunctionRequest) returns (haneul.rpc.v2.GetFunctionResponse);
	 */
	getFunction(
	...
	/**
	 * @generated from protobuf rpc: ListPackageVersions(haneul.rpc.v2.ListPackageVersionsRequest) returns (haneul.rpc.v2.ListPackageVersionsResponse);
	 */
	listPackageVersions(
