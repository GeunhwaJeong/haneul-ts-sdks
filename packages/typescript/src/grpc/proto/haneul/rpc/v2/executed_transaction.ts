...
// @generated from protobuf file "haneul/rpc/v2/executed_transaction.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
export interface ExecutedTransaction {
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.Transaction transaction = 2;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.TransactionEffects effects = 4;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.TransactionEvents events = 5;
	 */
	...
	timestamp?: Timestamp;
	/**
	 * @generated from protobuf field: repeated haneul.rpc.v2.BalanceChange balance_changes = 8;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.ObjectSet objects = 9;
	 */
	objects?: ObjectSet;
}
...
class ExecutedTransaction$Type extends MessageType<ExecutedTransaction> {
	constructor() {
		super('haneul.rpc.v2.ExecutedTransaction', [
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.ExecutedTransaction
 */
