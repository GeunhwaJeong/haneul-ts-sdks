...
// @generated from protobuf file "haneul/rpc/v2/protocol_config.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
class ProtocolConfig$Type extends MessageType<ProtocolConfig> {
	constructor() {
		super('haneul.rpc.v2.ProtocolConfig', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.ProtocolConfig
 */
