...
// @generated from protobuf file "haneul/rpc/v2/epoch.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
export interface Epoch {
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.ValidatorCommittee committee = 2;
	 */
	committee?: ValidatorCommittee;
	/**
	 * Snapshot of Sui's SystemState (`0x3::haneul_system::SystemState`) at the
	 * beginning of the epoch, for past epochs, or the current state for the
	 * current epoch.
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.SystemState system_state = 3;
	 */
	...
	/**
	 * @generated from protobuf field: optional haneul.rpc.v2.ProtocolConfig protocol_config = 9;
	 */
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.Epoch
 */
