...
//
// The temp file is written under `tests/` so module resolution finds `@haneullabs/haneul` via the
// codegen package's own `node_modules` (workspace symlinks).
describe('generated utils/index.ts typechecks', () => {
	// `ts.createProgram` plus `getPreEmitDiagnostics` over the @haneullabs/haneul type tree
