---
title: Haneul TypeScript Codegen
description: Generate type-safe TypeScript bindings from onchain Haneul Move packages.
keywords:
  [
    codegen,
    code generation,
...
<Callout type="warn">
	...
	[Core API docs](/haneul/clients/core#objectbcs) for details.
</Callout>
...
import { Balance } from './contracts/counter/deps/haneul/balance';

Balance.typeTag({ typeArguments: ['0x2::haneul::HANEUL'] });
...
Balance.typeTag({ typeArguments: ['0x2::haneul::HANEUL'] }); // ok
...
// '0x0000…0002::balance::Balance<0x0000…0002::haneul::HANEUL>'
```
...
- [Transaction building](/haneul/transactions/basics)
- [dApp Kit](/dapp-kit)
