---
title: Seal SDK
description: Decentralized secrets management with threshold encryption on Haneul.
keywords:
  [
    Seal,
    encryption,
...
<Callout type="info">
	This is a beta version of Seal. See https://github.com/GeunhwaJeong/seal for more details.
</Callout>

The Seal SDK provides threshold encryption capabilities for Haneul applications, enabling secure data
...
```ts
import { SessionKey } from '@haneullabs/seal';
