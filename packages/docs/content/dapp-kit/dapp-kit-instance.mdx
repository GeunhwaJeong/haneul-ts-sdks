...
The `createDAppKit` function is the foundation of your Haneul app. It creates an instance that manages
...
export const dAppKit = createDAppKit({
	networks: ['mainnet'],
	createClient: () =>
		new HaneulGrpcClient({ network: 'mainnet', baseUrl: 'http://158.69.54.239:9000' }),
	autoConnect: false,
});
```
