...
description: Programmatically connect to a Haneul wallet using the dApp Kit connectWallet action.
keywords: [connect wallet, dApp Kit, wallet connection, auto-connect, Haneul, action, TypeScript]
---
