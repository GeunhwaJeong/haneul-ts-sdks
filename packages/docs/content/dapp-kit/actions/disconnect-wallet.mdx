...
description:
  Programmatically disconnect from a Haneul wallet using the dApp Kit disconnectWallet action.
keywords: [disconnect wallet, dApp Kit, wallet disconnection, Haneul, action, TypeScript]
---
