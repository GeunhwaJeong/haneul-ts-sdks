...
description: Sign a Haneul transaction without executing it for deferred or multi-signature scenarios.
keywords:
  [sign transaction, dApp Kit, multi-signature, transaction signing, Haneul, wallet, TypeScript]
---
...
- The action transparently handles both `haneul:signTransaction` and `haneul:signTransactionBlock`
