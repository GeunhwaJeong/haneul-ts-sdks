...
description: React context provider that makes dApp Kit available throughout your application.
keywords: [DAppKitProvider, React provider, context, dApp Kit, configuration, Haneul, React hooks]
---
...
```tsx
import type { UiWallet } from '@haneullabs/dapp-kit-react';
import { useDAppKit, useCurrentAccount, useCurrentNetwork } from '@haneullabs/dapp-kit-react';
