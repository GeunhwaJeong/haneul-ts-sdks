...
description: React hook to get the currently selected wallet account in a Haneul dApp.
keywords: [useCurrentAccount, React hook, wallet account, current account, dApp Kit, Haneul]
---
