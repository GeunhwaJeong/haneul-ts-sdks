...
description: React hook to manage wallet connection status and information in a Haneul dApp.
keywords: [useWalletConnection, React hook, connection status, wallet, dApp Kit, Haneul, TypeScript]
---
...
```tsx
import { useWalletConnection } from '@haneullabs/dapp-kit-react';
