...
description: React hook to get the currently connected wallet in a Haneul dApp.
keywords: [useCurrentWallet, React hook, wallet connection, dApp Kit, Haneul, TypeScript]
---
...
```tsx
import { useCurrentWallet } from '@haneullabs/dapp-kit-react';
