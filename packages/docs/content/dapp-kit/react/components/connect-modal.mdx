---
title: Connect Modal
description: React modal component for selecting and connecting to a Haneul wallet.
keywords: [ConnectModal, React, wallet selection, modal dialog, dApp Kit, Haneul, UI component]
---
...
import { ConnectModal } from '@haneullabs/dapp-kit-react/ui';
