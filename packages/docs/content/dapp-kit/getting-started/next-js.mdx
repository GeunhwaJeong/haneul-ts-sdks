...
keywords: [Next.js, dApp Kit, SSR, server-side rendering, React, Haneul, TypeScript]
---
...
import { DAppKitProvider, useCurrentAccount, useDAppKit } from '@haneullabs/dapp-kit-react';
import { ConnectButton } from '@haneullabs/dapp-kit-react/ui';
...
See the complete
[Next.js example](https://github.com/GeunhwaJeong/haneul-ts-sdks/tree/main/packages/dapp-kit/examples/next-js/simple)
on GitHub.
