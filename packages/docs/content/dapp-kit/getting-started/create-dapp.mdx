---
title: '@haneullabs/create-dapp'
description: Create a Haneul app with one command using the create-dapp CLI scaffolding tool.
keywords: [create-dapp, CLI, scaffolding, Haneul, React, Vite, Tailwind CSS, project template]
---

`@haneullabs/create-dapp` is a CLI tool that scaffolds a complete Haneul app project with best practices
built in.
...
- TypeScript bindings generated with `@haneullabs/codegen`
...
- [`@haneullabs/dapp-kit-react`](/dapp-kit) - Wallet connection and blockchain interaction
- [pnpm](https://pnpm.io/) - Package management

The e2e-counter template also includes:

- [`@haneullabs/codegen`](/codegen) - Generate TypeScript from Move code
...
First, install the [Haneul CLI](https://docs.haneul.io/build/install) and set up testnet:
...
Get testnet HANEUL from the [faucet](https://faucet.haneul.io), then publish:
...
npm create @haneullabs/dapp -- -t react-e2e-counter

# Create with specific name
npm create @haneullabs/dapp -- -n my-app

# Create with both
npm create @haneullabs/dapp -- -t react-client-dapp -n my-app
```
