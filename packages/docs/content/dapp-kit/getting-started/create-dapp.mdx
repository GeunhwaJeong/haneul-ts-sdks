...
description: Create a Haneul dApp with one command
---

`@haneullabs/create-dapp` is a CLI tool that scaffolds a complete Haneul dApp project with best practices
built in.
