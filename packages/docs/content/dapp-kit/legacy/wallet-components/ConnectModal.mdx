---
title: ConnectModal
description: Legacy React modal component that guides users through connecting their wallet.
keywords: [ConnectModal, React component, wallet connection, modal, legacy, dApp Kit, Haneul]
---
