---
title: ConnectButton
description: Legacy React button component for connecting and disconnecting a Haneul wallet.
keywords: [ConnectButton, React component, wallet connection, button, legacy, dApp Kit, Haneul]
---
