...
description: Legacy React hook to sign a transaction without executing it on the Haneul network.
keywords: [useSignTransaction, React hook, sign transaction, wallet, legacy, dApp Kit, Haneul]
---
