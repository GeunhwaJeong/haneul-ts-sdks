...
description: Legacy React hook to check the auto-connection status for the last connected wallet.
keywords: [useAutoConnectWallet, React hook, auto-connect, wallet, legacy, dApp Kit, Haneul]
---
