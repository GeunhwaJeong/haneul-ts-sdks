...
keywords:
  [state management, nanostores, wallet state, dApp Kit, reactive stores, Haneul, framework-agnostic]
---

The Haneul dApp Kit SDK uses [nanostores](https://github.com/nanostores/nanostores) for state
...
Contains the HaneulClient instance for the current network:
