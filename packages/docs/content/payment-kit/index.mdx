...
title: Payment Kit
description:
  Accept payments in any coin type on the Haneul blockchain with built-in duplicate prevention.
keywords:
  [
    Payment Kit,
    Haneul payments,
...
The Haneul Payment Kit SDK is a TypeScript library that provides a straightforward and secure way to
process blockchain payments on the Haneul network. It offers flexible payment processing with built-in
duplicate prevention, configurable payment registries, and comprehensive receipt management.

## Overview

Payment Kit enables developers to integrate secure payment processing into their Haneul applications
...
- **Multi-coin Support**: Process payments with any Haneul coin type
