...
| `amount`   | Payment amount in smallest unit (e.g., GEUNHWA) |
| `coinType` | Coin type (e.g., `0x2::haneul::HANEUL`)            |
...
Check the
[CHANGELOG](https://github.com/GeunhwaJeong/ts-sdks/blob/main/packages/payment-kit/CHANGELOG.md) for
updates.
