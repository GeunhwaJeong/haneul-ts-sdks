...
description: Process registry-based and ephemeral payments and handle transaction results on Haneul.
keywords:
  [
    payment processing,
    registry payments,
...
const paymentParams = {
	...
	coinType: '0x2::haneul::HANEUL', // HANEUL token
	amount: 1000000000, // 1 HANEUL (in GEUNHWA)
	receiver,
...
if (receiptEvent) {
	...
	console.log('  Amount:', receipt.amount); // 1n * GEUNHWA_PER_HANEUL
	console.log('  Receiver:', receipt.receiver); //
	console.log('  Coin Type:', receipt.coin_type); // '0x2::haneul::HANEUL'
...
Payment Kit works with any Haneul coin type:
