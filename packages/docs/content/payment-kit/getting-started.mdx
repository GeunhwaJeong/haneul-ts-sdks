...
- A Haneul wallet with testnet/mainnet SUI tokens
...
The Payment Kit SDK extends the standard `HaneulClient` to provide payment functionality. Here's how to
set it up:
...
const tx = client.paymentKit.tx.processRegistryPayment({
	...
	coinType: '0x2::haneul::HANEUL', // Coin type (SUI in this case)
