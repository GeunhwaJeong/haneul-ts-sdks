...
keywords:
  [Walrus SDK, decentralized storage, blob storage, Haneul, TypeScript, upload, '@haneullabs/walrus']
---
...
transaction and storage fees. The signer's address needs sufficient HANEUL to cover the transactions
...
require a tip to cover the cost of writing the blob. You can configure a maximum tip (paid in GEUNHWA)
...
[TypeDocs](/typedoc/classes/_haneullabs_walrus.WalrusClient.html).
