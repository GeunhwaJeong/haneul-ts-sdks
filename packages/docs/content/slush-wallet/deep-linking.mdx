...
slush://swap?fromCoinType=0x2::haneul::HANEUL&toCoinType=0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC
...
| `amount`   | string | Yes      | Payment amount in smallest unit (e.g., GEUNHWA for HANEUL)   |
| `coinType` | string | Yes      | Coin type (e.g., `0x2::haneul::HANEUL`)                      |
