...
keywords:
  [Slush Wallet, app integration, registerSlushWallet, wallet standard, Haneul, web wallet, SDK]
---
...
If you're currently using `@haneullabs/zksend`'s `registerStashedWallet` directly, you should migrate to
the `@haneullabs/slush-wallet` package to ensure compatibility with the new Slush experience.
