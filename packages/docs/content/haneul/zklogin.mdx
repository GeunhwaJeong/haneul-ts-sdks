---
title: ZkLogin
description: Zero-knowledge authentication with OAuth providers on Haneul.
keywords: [zkLogin, zero-knowledge, authentication, OAuth, Haneul, signatures, address, '@haneullabs/haneul']
---
...
To use zkLogin inside a multisig, see the [Multisig Guide](../haneul/cryptography/signers/multisig) for
more details.
