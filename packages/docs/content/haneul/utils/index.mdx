...
description:
  'Utility functions for addresses, coins, and common operations in the Haneul TypeScript SDK.'
keywords:
  [
    utils,
    utility functions,
...
- `parseToMist`: Parse a HANEUL decimal string into GEUNHWA (9 decimals)
