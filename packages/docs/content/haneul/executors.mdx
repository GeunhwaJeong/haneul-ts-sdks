...
- `client`: An instance of a Haneul client (such as `SuiGrpcClient`) used to execute transactions.
...
<Callout type="warn">
	...
	will work correctly when all coin types are either HANEUL or the required balances are available as
