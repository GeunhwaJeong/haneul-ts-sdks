...
you must provide this information yourself. See also the Haneul documentation on
[offline signing](https://docs.haneul.io/guides/developer/transactions/transaction-auth/offline-signing)
...
| `setGasBudget()`  | Maximum gas to spend (in GEUNHWA)                                  |
