...
description: Connect to Haneul via gRPC with HaneulGrpcClient
---
...
[gRPC API docs](https://docs.haneul.io/concepts/data-access/grpc-overview).
...
the [gRPC overview](https://docs.haneul.io/concepts/data-access/grpc-overview).
