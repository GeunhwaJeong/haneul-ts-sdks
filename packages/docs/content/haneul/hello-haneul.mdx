---
title: Hello Haneul
description: Build your first Haneul application with the TypeScript SDK
---
...
The code imports the `requestHaneulFromFaucetV2` function from the SDK and calls it to mint HANEUL for the
provided address. The code also imports `HaneulGrpcClient` to create a new client on the Haneul network
