...
description: Migrate @haneullabs/seal to 2.0 with the new registration function pattern.
keywords: [migration, '@haneullabs/seal', Seal, 2.0, client extension, encryption, breaking changes]
---
