...
The gRPC client should work with almost all Haneul Labs SDKs as a drop in replacement for the JSON-RPC
...
- [SuiGrpcClient Documentation](/haneul/clients/grpc) - Full gRPC client documentation
- [SuiGraphQLClient Documentation](/haneul/clients/graphql) - GraphQL client documentation
