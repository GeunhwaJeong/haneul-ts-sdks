...
description: Migrate @haneullabs/kiosk to 2.0 with client extension pattern and KioskTransaction.
keywords:
  [migration, haneullabs/kiosk, Kiosk, 2.0, client extension, KioskTransaction, NFT, breaking changes]
---
