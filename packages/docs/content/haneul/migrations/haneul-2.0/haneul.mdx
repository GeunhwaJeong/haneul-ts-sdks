---
title: '@haneullabs/haneul'
---

## Removal of SuiClient Exports

The `@haneullabs/haneul/client` export path has been removed. All JSON-RPC client functionality is now
exported from `@haneullabs/haneul/jsonRpc`.
