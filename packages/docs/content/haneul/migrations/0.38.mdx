...
keywords:
  [migration, 0.38.0, upgrade, breaking changes, Haneul TypeScript SDK, module structure, refactoring]
---
...
[Haneul Programmable Transaction Block Basics](/haneul/transactions/basics) topic.
