...
description: Migrate to Haneul TypeScript SDK 1.0 with new features and API changes.
keywords:
  [
    migration,
    1.0,
...
- [A new GraphQL Client for the newly released Haneul GraphQL API](/haneul/clients/graphql)
...
```diff
- import { HaneulJsonRpcClient } from '@haneullabs/haneul.js'
+ import { HaneulJsonRpcClient } from '@haneullabs/haneul'
```
...
There are a few methods on HaneulJsonRpcClient that retain the `TransactionBlock` name because they
