...
| --------------- | ------------------ | -------------------------------- |
| Ed25519         | `Ed25519Keypair`   | `@haneullabs/sui/keypairs/ed25519`   |
| ECDSA Secp256k1 | `Secp256k1Keypair` | `@haneullabs/sui/keypairs/secp256k1` |
| ECDSA Secp256r1 | `Secp256r1Keypair` | `@haneullabs/sui/keypairs/secp256r1` |
...
To use, import the key pair class your project uses from the `@haneullabs/sui/keypairs` folder. For
example, to use the Ed25519 scheme, import the `Ed25519Keypair` class from
`@haneullabs/sui/keypairs/ed25519`.
...
```typescript
import { Ed25519Keypair, Ed25519PublicKey } from '@haneullabs/sui/keypairs/ed25519';
...
// or use `toHaneulAddress()` directly
...
import { Ed25519Keypair } from '@haneullabs/sui/keypairs/ed25519';
import { verifyTransactionSignature } from '@haneullabs/sui/verify';
...
[legacy versions of the zklogin address](https://sdk.haneullabs.com/typescript/zklogin#legacy-addresses).
...
import { Ed25519Keypair } from '@haneullabs/sui/keypairs/ed25519';
import { Secp256r1Keypair } from '@haneullabs/sui/keypairs/secp256r1';
import { Secp256k1Keypair } from '@haneullabs/sui/keypairs/secp256k1';
...
```typescript
import { encodeHaneulPrivateKey } from '@haneullabs/sui/cryptography';
...
```typescript
import { Ed25519Keypair } from '@haneullabs/sui/keypairs/ed25519';
import { fromHex } from '@haneullabs/sui/utils';
