...
description: Build kiosk transactions for listing, purchasing, and managing items on Haneul.
keywords: [KioskTransaction, transaction builder, kiosk, listing, purchasing, PTB, Haneul, TypeScript]
---
