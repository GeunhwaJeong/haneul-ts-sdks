...
pnpm --filter @haneullabs/sponsor dev:sponsor-server
```

Optional environment variables:

- `FULLNODE_URL`: Haneul gRPC fullnode URL. Defaults to Testnet.
- `MAX_GAS_BUDGET`: Maximum sponsored gas budget in GEUNHWA. Defaults to `50000000`.
