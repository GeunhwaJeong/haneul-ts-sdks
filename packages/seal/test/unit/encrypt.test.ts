...
describe('Seal encryption tests', () => {
	...
	it('check share consistency', async () => {
		...
		// Generated using this Rust unit test: https://github.com/GeunhwaJeong/seal/blob/828e0e90ea0282c59836c4d9cb7ec9e9f47d5d3a/crates/crypto/src/lib.rs#L668-L725
