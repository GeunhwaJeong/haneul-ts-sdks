...
export const ROYALTY_RULE_ADDRESS: Partial<Record<HaneulClientTypes.Network, string>> = {
...
export const KIOSK_LOCK_RULE_ADDRESS: Partial<Record<HaneulClientTypes.Network, string>> = {
	['testnet']: 'bd8fc1947cf119350184107a3087e2dc27efefa0dd82e25a1f699069fe81a585',
	['mainnet']: '0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879',
};

export const FLOOR_PRICE_RULE_ADDRESS: Partial<Record<HaneulClientTypes.Network, string>> = {
...
export const PERSONAL_KIOSK_RULE_ADDRESS: Partial<Record<HaneulClientTypes.Network, string>> = {
	['testnet']: '0x06f6bdd3f2e2e759d8a4b9c252f379f7a05e72dfe4c0b9311cdac27b8eb791b1',
