...
import { getWallets, StandardEvents } from '@haneullabs/wallet-standard';
...
import type { StandardEventsFeature, Wallet, WalletWithFeatures } from '@haneullabs/wallet-standard';
