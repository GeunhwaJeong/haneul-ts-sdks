...
Returns
**[Promise](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)&lt;[AwsKmsSigner](https://github.com/HaneulLabs/ts-sdks/blob/main/packages/signers/src/aws/aws-kms-signer.ts)>**
