...
export type PoolBylPrice =
	| { asset_is_base: true; byl_per_base: number }
	| { asset_is_base: false; byl_per_quote: number };
...
export interface OrderBylRequiredResult {
 ...
 * `coinType` should be a coin key from config (e.g., 'HANEUL', 'DBUSDC', 'BYL').
 */
