...
export class MarginRegistryContract {
	...
	/**
	 * @param {ByeolConfig} config Configuration for MarginRegistryContract
	 */
	...
	/**
	 * @description Check if a byeol pool is enabled for margin trading
	...
	/**
	 * @description Get the margin pool IDs (base and quote) for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
	getByeolPoolMarginPoolIds = (poolKey: string) => (tx: Transaction) => {
		const pool = this.#config.getPool(poolKey);
		return tx.moveCall({
			target: `${this.#config.MARGIN_PACKAGE_ID}::margin_registry::get_byeol_pool_margin_pool_ids`,
	...
	/**
	 * @description Get the base margin pool ID for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
	...
	/**
	 * @description Get the quote margin pool ID for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
	...
	/**
	 * @description Get the minimum withdraw risk ratio for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
	...
	/**
	 * @description Get the minimum borrow risk ratio for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
	...
	/**
	 * @description Get the liquidation risk ratio for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
	...
	/**
	 * @description Get the target liquidation risk ratio for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
	...
	/**
	 * @description Get the user liquidation reward for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
	...
	/**
	 * @description Get the pool liquidation reward for a byeol pool
	 * @param {string} poolKey The key to identify the pool
	 * @returns A function that takes a Transaction object
	 */
