...
const $moduleName = '@byeol/core::registry';
...
export const ByeolAdminCap = new MoveStruct({
	name: `${$moduleName}::ByeolAdminCap`,
	fields: {
		id: bcs.Address,
	},
});
...
/** Authorize an application to access protected features of the Byeol. */
 ...
 * treasury address is the publisher of the byeol package
 */
