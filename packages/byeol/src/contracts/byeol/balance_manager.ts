...
const $moduleName = '@byeol/core::balance_manager';
...
export const ByeolReferral = new MoveStruct({
	name: `${$moduleName}::ByeolReferral`,
	fields: {
		id: bcs.Address,
		owner: bcs.Address,
	},
});
export const ByeolPoolReferral = new MoveStruct({
	name: `${$moduleName}::ByeolPoolReferral`,
	fields: {
		id: bcs.Address,
		owner: bcs.Address,
		pool_id: bcs.Address,
...
export const ByeolReferralCreatedEvent = new MoveStruct({
	name: `${$moduleName}::ByeolReferralCreatedEvent`,
	fields: {
		referral_id: bcs.Address,
		owner: bcs.Address,
	},
});
export const ByeolReferralSetEvent = new MoveStruct({
	name: `${$moduleName}::ByeolReferralSetEvent`,
	fields: {
		referral_id: bcs.Address,
		balance_manager_id: bcs.Address,
	},
