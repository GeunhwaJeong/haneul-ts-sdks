...
/**
 * @description Base class for Byeol errors
 */
export class ByeolError extends Error {
	constructor(message: string) {
		super(message);
		this.name = 'ByeolError';
	}
}
 ...
 */
export class ResourceNotFoundError extends ByeolError {
 ...
 */
export class ConfigurationError extends ByeolError {
	constructor(message: string) {
		super(message);
 ...
 */
export class ValidationError extends ByeolError {
	constructor(message: string) {
		super(message);
