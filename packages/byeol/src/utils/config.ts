...
import type { CoinMap, PoolMap, MarginPoolMap, ByeolPackageIds } from './constants.js';
...
export const BYL_SCALAR = 1_000_000; // 10^6 - BYL token decimal places
...
export const POOL_CREATION_FEE_BYL = 500_000_000; // 500 BYL tokens (500 * 10^6)

export class ByeolConfig {
	#coins: CoinMap;
	#pools: PoolMap;
	...
	constructor({
		...
		if (packageIds) {
			this.BYEOL_PACKAGE_ID = packageIds.BYEOL_PACKAGE_ID || '';
			this.REGISTRY_ID = packageIds.REGISTRY_ID || '';
			this.BYL_TREASURY_ID = packageIds.BYL_TREASURY_ID || '';
			...
			this.BYEOL_PACKAGE_ID = mainnetPackageIds.BYEOL_PACKAGE_ID;
			this.REGISTRY_ID = mainnetPackageIds.REGISTRY_ID;
			this.BYL_TREASURY_ID = mainnetPackageIds.BYL_TREASURY_ID;
			...
			this.BYEOL_PACKAGE_ID = testnetPackageIds.BYEOL_PACKAGE_ID;
			this.REGISTRY_ID = testnetPackageIds.REGISTRY_ID;
			this.BYL_TREASURY_ID = testnetPackageIds.BYL_TREASURY_ID;
