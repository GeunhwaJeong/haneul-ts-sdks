...
This is the Haneul TypeScript SDK providing utility classes and functions for applications to sign
transactions and interact with the Haneul network. It supports multiple communication protocols
...
https://sdk.haneul-labs.com/typedoc/index.html.
...
The `HaneulGrpcClient` class provides a connection to the Haneul network via gRPC and is the recommended
...
You can also construct your own HaneulGrpcClient connections with the URL for your own fullnode:
...
You can request haneul from the faucet when running against devnet or localnet. For testnet, visit
faucet.haneul.io.
