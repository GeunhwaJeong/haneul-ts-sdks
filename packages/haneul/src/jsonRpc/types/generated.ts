...
export type HaneulCallArg =
	...
	| {
			reservation: HaneulReservation;
			type: 'fundsWithdrawal';
			typeArg: HaneulWithdrawalTypeArg;
			withdrawFrom: HaneulWithdrawFrom;
	  };
...
export interface HaneulMoveAbort {
...
export type HaneulWithdrawFrom = 'sender' | 'sponsor';
export type HaneulWithdrawalTypeArg = {
	balance: string;
};
