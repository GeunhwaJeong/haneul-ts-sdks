...
import { isValidHaneulNSName } from './haneulns.js';
import { isValidStructTag } from './haneul-types.js';
...
export const isValidNamedPackage = (name: string): boolean => {
	...
	// Check if the org is a valid HaneulNS name.
	if (!isValidHaneulNSName(org)) return false;
