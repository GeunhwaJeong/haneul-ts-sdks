...
export class HaneulClientError extends Error {}

export class SimulationError extends HaneulClientError {
	executionError?: HaneulClientTypes.ExecutionError;

	constructor(
		message: string,
		options?: { cause?: unknown; executionError?: HaneulClientTypes.ExecutionError },
	) {
...
export class ObjectError extends HaneulClientError {
	code: string;
