...
import type { Transaction as GrpcTransaction } from '../grpc/proto/haneul/rpc/v2/transaction.js';
import {
...
/**
 * Converts an array of ObjectReferences from gRPC format to TypeScript HaneulObjectRef format
 */
