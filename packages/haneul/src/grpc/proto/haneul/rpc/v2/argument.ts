...
// @generated from protobuf file "haneul/rpc/v2/argument.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message haneul.rpc.v2.Argument
 */
export interface Argument {
	/**
	 * @generated from protobuf field: optional haneul.rpc.v2.Argument.ArgumentKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum haneul.rpc.v2.Argument.ArgumentKind
 */
...
class Argument$Type extends MessageType<Argument> {
	constructor() {
		super('haneul.rpc.v2.Argument', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => ['haneul.rpc.v2.Argument.ArgumentKind', Argument_ArgumentKind],
			},
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.Argument
 */
