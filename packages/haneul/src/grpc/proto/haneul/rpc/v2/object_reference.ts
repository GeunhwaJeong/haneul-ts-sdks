...
// @generated from protobuf file "haneul/rpc/v2/object_reference.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message haneul.rpc.v2.ObjectReference
 */
...
class ObjectReference$Type extends MessageType<ObjectReference> {
	constructor() {
		super('haneul.rpc.v2.ObjectReference', [
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.ObjectReference
 */
