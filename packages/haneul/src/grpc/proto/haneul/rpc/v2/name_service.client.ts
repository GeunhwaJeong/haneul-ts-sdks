...
export interface INameServiceClient {
	/**
	 * @generated from protobuf rpc: LookupName(haneul.rpc.v2.LookupNameRequest) returns (haneul.rpc.v2.LookupNameResponse);
	 */
	lookupName(
	...
	/**
	 * @generated from protobuf rpc: ReverseLookupName(haneul.rpc.v2.ReverseLookupNameRequest) returns (haneul.rpc.v2.ReverseLookupNameResponse);
	 */
	reverseLookupName(
