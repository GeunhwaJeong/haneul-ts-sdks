...
// @generated from protobuf file "haneul/rpc/v2/gas_cost_summary.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message haneul.rpc.v2.GasCostSummary
 */
...
class GasCostSummary$Type extends MessageType<GasCostSummary> {
	constructor() {
		super('haneul.rpc.v2.GasCostSummary', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.GasCostSummary
 */
