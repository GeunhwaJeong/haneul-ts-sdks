...
// @generated from protobuf file "haneul/rpc/v2/balance_change.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message haneul.rpc.v2.BalanceChange
 */
...
class BalanceChange$Type extends MessageType<BalanceChange> {
	constructor() {
		super('haneul.rpc.v2.BalanceChange', [
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.BalanceChange
 */
