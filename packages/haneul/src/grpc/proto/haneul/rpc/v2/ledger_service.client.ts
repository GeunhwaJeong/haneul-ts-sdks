...
export interface ILedgerServiceClient {
	 ...
	 *
	 * @generated from protobuf rpc: GetServiceInfo(haneul.rpc.v2.GetServiceInfoRequest) returns (haneul.rpc.v2.GetServiceInfoResponse);
	 */
	getServiceInfo(
	...
	/**
	 * @generated from protobuf rpc: GetObject(haneul.rpc.v2.GetObjectRequest) returns (haneul.rpc.v2.GetObjectResponse);
	 */
	getObject(
	...
	/**
	 * @generated from protobuf rpc: BatchGetObjects(haneul.rpc.v2.BatchGetObjectsRequest) returns (haneul.rpc.v2.BatchGetObjectsResponse);
	 */
	batchGetObjects(
	...
	/**
	 * @generated from protobuf rpc: GetTransaction(haneul.rpc.v2.GetTransactionRequest) returns (haneul.rpc.v2.GetTransactionResponse);
	 */
	getTransaction(
	...
	/**
	 * @generated from protobuf rpc: BatchGetTransactions(haneul.rpc.v2.BatchGetTransactionsRequest) returns (haneul.rpc.v2.BatchGetTransactionsResponse);
	 */
	...
	/**
	 * @generated from protobuf rpc: GetCheckpoint(haneul.rpc.v2.GetCheckpointRequest) returns (haneul.rpc.v2.GetCheckpointResponse);
	 */
	getCheckpoint(
	...
	/**
	 * @generated from protobuf rpc: GetEpoch(haneul.rpc.v2.GetEpochRequest) returns (haneul.rpc.v2.GetEpochResponse);
	 */
	getEpoch(
