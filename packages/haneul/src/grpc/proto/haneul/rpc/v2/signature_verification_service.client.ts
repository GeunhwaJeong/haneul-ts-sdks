...
/**
 * @generated from protobuf service haneul.rpc.v2.SignatureVerificationService
 */
export interface ISignatureVerificationServiceClient {
	 ...
	 *
	 * @generated from protobuf rpc: VerifySignature(haneul.rpc.v2.VerifySignatureRequest) returns (haneul.rpc.v2.VerifySignatureResponse);
	 */
	verifySignature(
