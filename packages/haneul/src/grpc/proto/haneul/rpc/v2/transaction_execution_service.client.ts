...
/**
 * @generated from protobuf service haneul.rpc.v2.TransactionExecutionService
 */
export interface ITransactionExecutionServiceClient {
	/**
	 * @generated from protobuf rpc: ExecuteTransaction(haneul.rpc.v2.ExecuteTransactionRequest) returns (haneul.rpc.v2.ExecuteTransactionResponse);
	 */
	executeTransaction(
	...
	/**
	 * @generated from protobuf rpc: SimulateTransaction(haneul.rpc.v2.SimulateTransactionRequest) returns (haneul.rpc.v2.SimulateTransactionResponse);
	 */
	simulateTransaction(
