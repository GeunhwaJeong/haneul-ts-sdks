...
/**
 * @generated from protobuf service haneul.rpc.v2.StateService
 */
export interface IStateServiceClient {
	/**
	 * @generated from protobuf rpc: ListDynamicFields(haneul.rpc.v2.ListDynamicFieldsRequest) returns (haneul.rpc.v2.ListDynamicFieldsResponse);
	 */
	listDynamicFields(
	...
	/**
	 * @generated from protobuf rpc: ListOwnedObjects(haneul.rpc.v2.ListOwnedObjectsRequest) returns (haneul.rpc.v2.ListOwnedObjectsResponse);
	 */
	listOwnedObjects(
	...
	/**
	 * @generated from protobuf rpc: GetCoinInfo(haneul.rpc.v2.GetCoinInfoRequest) returns (haneul.rpc.v2.GetCoinInfoResponse);
	 */
	getCoinInfo(
	...
	/**
	 * @generated from protobuf rpc: GetBalance(haneul.rpc.v2.GetBalanceRequest) returns (haneul.rpc.v2.GetBalanceResponse);
	 */
	getBalance(
	...
	/**
	 * @generated from protobuf rpc: ListBalances(haneul.rpc.v2.ListBalancesRequest) returns (haneul.rpc.v2.ListBalancesResponse);
	 */
	listBalances(
