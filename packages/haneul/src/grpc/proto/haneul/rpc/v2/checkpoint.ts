...
// @generated from protobuf file "haneul/rpc/v2/checkpoint.proto" (package "haneul.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
/**
 * @generated from protobuf message haneul.rpc.v2.Checkpoint
 */
export interface Checkpoint {
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.CheckpointSummary summary = 3;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.ValidatorAggregatedSignature signature = 4;
	 */
	signature?: ValidatorAggregatedSignature;
	/**
	 * The `CheckpointContents` for this checkpoint.
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.CheckpointContents contents = 5;
	 */
	contents?: CheckpointContents;
	/**
	 * List of transactions included in this checkpoint.
	 *
	 * @generated from protobuf field: repeated haneul.rpc.v2.ExecutedTransaction transactions = 6;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional haneul.rpc.v2.ObjectSet objects = 7;
	 */
	objects?: ObjectSet;
}
...
class Checkpoint$Type extends MessageType<Checkpoint> {
	constructor() {
		super('haneul.rpc.v2.Checkpoint', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message haneul.rpc.v2.Checkpoint
 */
