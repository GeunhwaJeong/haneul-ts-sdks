...
// @generated from protobuf file "haneul/forking/v1alpha/forking_service.proto" (package "haneul.forking.v1alpha", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
/**
 * @generated from protobuf message haneul.forking.v1alpha.AdvanceClockRequest
 */
...
/**
 * @generated from protobuf message haneul.forking.v1alpha.AdvanceClockResponse
 */
...
/**
 * @generated from protobuf message haneul.forking.v1alpha.AdvanceCheckpointRequest
 */
export interface AdvanceCheckpointRequest {}
/**
 * @generated from protobuf message haneul.forking.v1alpha.AdvanceCheckpointResponse
 */
...
/**
 * @generated from protobuf message haneul.forking.v1alpha.GetStatusRequest
 */
export interface GetStatusRequest {}
/**
 * @generated from protobuf message haneul.forking.v1alpha.GetStatusResponse
 */
...
class AdvanceClockRequest$Type extends MessageType<AdvanceClockRequest> {
	constructor() {
		super('haneul.forking.v1alpha.AdvanceClockRequest', [
			{
				no: 1,
				name: 'duration_ms',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message haneul.forking.v1alpha.AdvanceClockRequest
 */
...
class AdvanceClockResponse$Type extends MessageType<AdvanceClockResponse> {
	constructor() {
		super('haneul.forking.v1alpha.AdvanceClockResponse', [
			{
				no: 1,
				name: 'timestamp_ms',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message haneul.forking.v1alpha.AdvanceClockResponse
 */
...
class AdvanceCheckpointRequest$Type extends MessageType<AdvanceCheckpointRequest> {
	constructor() {
		super('haneul.forking.v1alpha.AdvanceCheckpointRequest', []);
	}
}
/**
 * @generated MessageType for protobuf message haneul.forking.v1alpha.AdvanceCheckpointRequest
 */
...
class AdvanceCheckpointResponse$Type extends MessageType<AdvanceCheckpointResponse> {
	constructor() {
		super('haneul.forking.v1alpha.AdvanceCheckpointResponse', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message haneul.forking.v1alpha.AdvanceCheckpointResponse
 */
...
class GetStatusRequest$Type extends MessageType<GetStatusRequest> {
	constructor() {
		super('haneul.forking.v1alpha.GetStatusRequest', []);
	}
}
/**
 * @generated MessageType for protobuf message haneul.forking.v1alpha.GetStatusRequest
 */
...
class GetStatusResponse$Type extends MessageType<GetStatusResponse> {
	constructor() {
		super('haneul.forking.v1alpha.GetStatusResponse', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message haneul.forking.v1alpha.GetStatusResponse
 */
export const GetStatusResponse = new GetStatusResponse$Type();
/**
 * @generated ServiceType for protobuf service haneul.forking.v1alpha.ForkingService
 */
export const ForkingService = new ServiceType('haneul.forking.v1alpha.ForkingService', [
