 ...
 *
 * @generated from protobuf service haneul.forking.v1alpha.ForkingService
 */
export interface IForkingServiceClient {
	/**
	 * Advance the forked network's clock by a given duration.
	 *
	 * @generated from protobuf rpc: AdvanceClock(haneul.forking.v1alpha.AdvanceClockRequest) returns (haneul.forking.v1alpha.AdvanceClockResponse);
	 */
	advanceClock(
	 ...
	 *
	 * @generated from protobuf rpc: AdvanceCheckpoint(haneul.forking.v1alpha.AdvanceCheckpointRequest) returns (haneul.forking.v1alpha.AdvanceCheckpointResponse);
	 */
	advanceCheckpoint(
	 ...
	 *
	 * @generated from protobuf rpc: GetStatus(haneul.forking.v1alpha.GetStatusRequest) returns (haneul.forking.v1alpha.GetStatusResponse);
	 */
	getStatus(
