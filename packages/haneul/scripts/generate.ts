...
const res = await fetch(
	'https://raw.githubusercontent.com/GeunhwaJeong/haneul/refs/heads/main/crate./haneul-open-rpc/spec/openrpc.json',
);
...
const options: {
	...
	types: {
		...
		HaneulProgrammableMoveCall: { alias: 'MoveCallSuiTransaction' },
