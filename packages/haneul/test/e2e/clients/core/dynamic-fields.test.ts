...
import type { HaneulGrpcClient } from '../../../../src/grpc/index.js';
import type { HaneulGraphQLClient } from '../../../../src/graphql/index.js';
...
describe('Core API - Dynamic Fields', () => {
	...
	describe('listDynamicFields with include: { value: true }', () => {
		it('[gRPC] should return value BCS when include value is true', async () => {
			const grpcClient = toolbox.grpcClient as HaneulGrpcClient;
		...
		it('[GraphQL] should return value BCS when include value is true', async () => {
			const graphqlClient = toolbox.graphqlClient as HaneulGraphQLClient;
