...
import { requestHaneulFromFaucetV2, FaucetRateLimitError } from '../../../src/faucet/index.js';
import { Transaction } from '../../../src/transactions/index.js';
import { normalizeHaneulAddress } from '../../../src/utils/index.js';
import { HaneulGrpcClient } from '../../../src/grpc/client.js';
...
export async function prePublishPackages(
	...
	// Publish each package. The default haneul config at /root/.haneul/haneul_config/client.yaml
...
async function publishSinglePackage(options: {
	...
	const packageId = normalizeHaneulAddress(publishedChange.objectId);
...
async function setupDemoBearDisplayV2(options: {
	...
	const DISPLAY_REGISTRY_ID = normalizeHaneulAddress('0xd');
