...
describe('zkLogin address', () => {
	...
	test('computeZkLoginAddressFromSeed matches ZkLoginPublicIdentifier.toHaneulAddress() for legacy addresses', () => {
		const seed = BigInt(
	...
	test('computeZkLoginAddressFromSeed matches ZkLoginPublicIdentifier.toHaneulAddress() for non-legacy addresses', () => {
		const seed = BigInt(
			'380704556853533152350240698167704405529973457670972223618755249929828551006',
		);
		const iss = 'https://accounts.google.com';
